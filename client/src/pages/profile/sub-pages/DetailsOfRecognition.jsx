...
export default function DetailsOfRecognition() {
                ...
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 w-full sm:max-w-lg sm:p-6">
                  ...
                  <div className="ml-4 my-6 flex flex-col gap-3">
                    ...
                    <InputTag
                      type="text"
                      name="authority"
                      label="Statutory / Regulatory Authority:"
                    />
                    <InputTag
                      type="text"
                      name="details"
                      label="Recognition/Approval Details, Institution/Department Programme:"
                    />
      ...
      <div className="flex justify-between items-end w-full">
        <div>
          <span className="font-medium flex flex-col gap-3">
            9. Details of recognition/approval by statutory/regulatory bodies like AICTE, NCTE, MCI, DCI, PCI, RCI etc (other than UGC)
          </span>
