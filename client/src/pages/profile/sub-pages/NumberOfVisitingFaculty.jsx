...
export default function NumberOfVisitingFaculty() {
  return (
    <>
      <span className="font-medium">
        18. Number of Visiting Faculty / Guest Faculty engaged with the College
      </span>
      ...
      <form className="flex flex-col gap-6">
        <InputTag
          type="number"
          name="number-of-visiting-faculty"
          label="Number of Visiting Faculty /Guest Faculty engaged with the College"
        />
