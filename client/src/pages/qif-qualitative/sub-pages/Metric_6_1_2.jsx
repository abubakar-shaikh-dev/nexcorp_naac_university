...
export default function Metric_6_1_2() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 6.1.2</span>
        ...
        <span className="text-red-500 text-sm">
          Note : Describe a case study showing decentralization and
          participative management in the institution in practice within a
