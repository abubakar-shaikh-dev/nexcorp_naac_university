...
export default function Metric_2_6_1() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 2.6.1</span>
        ...
        <span className="text-red-500 text-sm">
          Note: Describe Course Outcomes (COs) for all courses and mechanism of communication within a minimum of 500 characters and maximum of 500 words
        </span>
