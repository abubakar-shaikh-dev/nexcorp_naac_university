...
export default function Metric_6_4_3() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 6.4.3</span>
        ...
        <span className="text-red-500 text-sm">
          Note : Describe the resource mobilisation policy and procedures of the Institution within a maximum of 500 words.
        </span>
