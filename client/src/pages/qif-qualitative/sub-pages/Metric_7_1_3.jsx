...
export default function Metric_7_1_3() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 7_1_3</span>
        ...
        Note : Describe one activity successfully implemented based on the strategic plan within a maximum of 500 words
        </span> */}
            ...
            <div className="flex flex-col my-2 ">
              <div className="flex flex-row">
                <div className="flex justify-between items-center p-6 w-[66.66%] border border-gray-400 ">
                  <span  className="w-[66.66%]">Relevant documents like agreements/MoUs with Government and other approved agencies</span>
