...
export default function Metric_6_3_1() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 6.3.1</span>
        ...
        <span className="text-red-500 text-sm">
          Note : Provide the list of existing welfare measures for teaching and nonteaching staff within a maximum of 500 words.
        </span>
