...
export default function Metric_7_1_11() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 7.1.11</span>
        ...
        Note : Describe the efforts of the Institution in celebrating /organizing national and international commemorative days, events and festivals during the last five years within 500 words.
        </span>
            ...
            <div className="flex flex-col my-2 ">
              <div className="flex flex-row">
                <div className="flex justify-between items-center p-6 w-[66.66%] border border-gray-400 ">
                  <span  className="w-[66.66%]">Annual report of the celebrations and commemorative events for the last five years</span>
