...
export default function Metric_4_4_2() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 4.4.2</span>
        ...
        <span className="text-red-500 text-sm">
          Note : Describe policy details of systems and procedures for maintaining and utilizing physical, academic and support facilities on the website within a maximum of 1000 words.
        </span>
