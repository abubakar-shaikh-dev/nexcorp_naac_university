...
export default function Metric_6_2_2() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 6.2.2</span>
        ...
        Note : Describe the Organogram of the Institution within a maximum 500 words.
        </span>
