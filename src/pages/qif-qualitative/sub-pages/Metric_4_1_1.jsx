...
export default function Metric_4_1_1() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 4.1.1</span>
        ...
        <span className="text-red-500 text-sm">
          Note : Describe the adequacy of infrastructure and physical facilities
          for teaching –learning as per the minimum specified requirement by
