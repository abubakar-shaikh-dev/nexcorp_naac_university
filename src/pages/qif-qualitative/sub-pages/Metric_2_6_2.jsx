...
export default function Metric_2_6_2() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 2.6.2</span>
        ...
        <span className="text-red-500 text-sm">
          Note: Describe the method of measuring the level of attainment of POs , PSOs and COs in not more than 500 words
        </span>
