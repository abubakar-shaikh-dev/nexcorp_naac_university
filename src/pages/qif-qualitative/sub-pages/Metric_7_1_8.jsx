...
export default function Metric_7_1_8() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 7.1.8</span>
        ...
        <span>
          ...
          regional, linguistic, communal socioeconomic and other diversities
          (within 500 words)
        </span>
