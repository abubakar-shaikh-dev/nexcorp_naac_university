...
export default function Metric_4_1_2() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 4.1.2</span>
        ...
        <span className="text-red-500 text-sm">
          Note : Describe the adequacy of facilities for sports, games and cultural activities which include specification about area/size, year of establishment and user rate within a maximum of 500 words.
        </span>
