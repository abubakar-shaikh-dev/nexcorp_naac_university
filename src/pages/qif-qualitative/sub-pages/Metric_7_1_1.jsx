...
export default function Metric_7_1_1() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 7.1.1</span>
        ...
        <span className="text-red-500 text-sm">
          Note : Describe gender equity & sensitization in curricular and co-curricular activities, facilities for women on campus etc., within 500 words.
        </span>
            ...
            <div>
              ...
              <div className="flex flex-col my-2 ">
                <div className="flex flex-row">
                  ...
                  Provide Web link to: Annual gender sensitization action plan
                  </div>
                ...
                <div className="flex flex-row">
                  ...
                  <ul>
                    <li>a) Safety and security</li>
                    <li>b) Counselling</li>
                    <li>c) Common Rooms</li>
                    <li>d) Day care center for young children</li>
                    <li>e) Any other relevant information</li>
                  </ul>
                  </div>
