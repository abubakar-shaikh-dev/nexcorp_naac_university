...
export default function Metric_5_3_2() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 5.3.2</span>
        ...
        <span>
        Institution facilitates student’s representation and engagement in various administrative, co-curricular and extracurricular activities (student council/ students representation on various bodies as per established processes and norms )
        </span>

        <span className="text-red-500 text-sm">
          Note : Describe the student’s representation and engagement in various administrative, co-curricular and extracurricular activities within a maximum of 500 words.
        </span>
            ...
            <div className="flex flex-col my-2 ">
              <div className="flex flex-row">
                <div className="flex justify-between items-center p-6 w-[66.66%] border border-gray-400 rounded-tl-md">
                  <span className="w-[66.66%]">Paste link for Additional information</span>
