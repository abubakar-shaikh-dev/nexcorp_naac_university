...
export default function Metric_6_3_5() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 6.3.5</span>
        ...
        <span className="text-red-500 text-sm">
          Note : Describe the functioning status of the Performance Appraisal System for teaching and non-teaching staff within a maximum of 500 words.
        </span>
