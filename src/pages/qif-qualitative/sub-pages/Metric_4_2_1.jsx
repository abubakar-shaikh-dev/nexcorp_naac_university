...
export default function Metric_4_2_1() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 4.2.1</span>
        ...
        <span className="text-red-500 text-sm">
          Note : Data Requirement for last five years: Upload a description of
          library with,
          <ul className="list-disc pl-16">
            <li>Name of ILMS software</li>
            <li>Nature of automation (fully or partially)</li>
            <li>Version</li>
            <li>Year of Automation</li>
          </ul>
        </span>
