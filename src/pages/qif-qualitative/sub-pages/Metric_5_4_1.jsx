...
export default function Metric_5_4_1() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 5.4.1</span>
        ...
        <span className="text-red-500 text-sm">
          Note : Describe contribution of alumni association to the institution
