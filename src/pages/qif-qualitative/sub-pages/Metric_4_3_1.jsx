...
export default function Metric_4_3_1() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 4.3.1</span>
        ...
        <span className="text-red-500 text-sm">
          Note : Describe IT facilities including Wi-Fi with date and nature of updation within a maximum of 500 words.
        </span>
