...
export default function Metric_1_3_1() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 1.3.1</span>
        ...
        <span className="text-red-500 text-sm">
          Note: Upload a description in maximum of 500 words
        </span>
              ...
              <div className="flex flex-col my-2 ">
                ...
                <div className="flex flex-row">
                  <div className="p-6 w-1/2 border border-gray-400 rounded-bl-md">
                    Upload the list and description of courses which address the
