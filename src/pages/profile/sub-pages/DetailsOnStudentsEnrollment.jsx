...
export default function DetailsOnStudentsEnrollment() {
              ...
              >
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 w-full sm:max-w-lg sm:p-6">
                  ...
                  <div className="mx-2 my-6 flex flex-col gap-6">
                    <SelectTag
                      name="type-of-students"
                      label="Type Of Students"
                      data={[
                        { id: 0, value: "Students from the same state where the college is located" },
                        { id: 1, value: "Students from other states of India" },
                        { id: 2, value: "NRI students" },
                        { id: 3, value: "Foreign students" }
                      ]}
                    />
      ...
      <div className="flex justify-between items-end w-full">
        <div>
          <span className="font-medium flex flex-col gap-3">
            20. Details on students enrollment in the college during the current
            academic year
          </span>
