    ...
    <>
              ...
              >
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 w-full sm:max-w-lg sm:p-6">
                  ...
                  <div className="ml-4 my-6 flex flex-col gap-3">
                    ...
                    <InputTag type="text" name="campus-type" label="Campus Type" />
                    ...
                    <TextareaTag name="programmes-offered" label="Programmes Offered"/>

                    
                    <InputTag type="date" name="date-of-establishment" label="Date of Establishment" />
                    <InputTag type="date" name="date-of-recognition" label="Date of Recognition by UCG/MHRD" />
      ...
      <div className="flex justify-between items-end w-full">
        <div>
          ...
          7. Location, Area and Activity of Campus
          </span>
