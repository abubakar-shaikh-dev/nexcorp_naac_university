...
export default function Metric_1_4_2() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 1.4.2</span>
        ...
        <span>
          ...
          <ul className="pl-6 list-decimal text-sm text-gray-700 space-y-5 mt-5">
            ...
            <li>Feedback collected, analysed and action has been taken</li>
        ...
        <div>
            ...
            <div className="my-2">
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/1.4.2 Template.xlsx"
          ...
          <div className="flex flex-col gap-3 mt-8">
            ...
            <span className=" pl-4 mt-2">Documents:</span>
