...
export default function Metric_7_1_7() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 7.1.7</span>
        ...
        <div className="flex justify-between items-start">
          <span className="text-sm">Weightage : 4</span>
        ...
        <span>
          ...
          <ul className="pl-6 list-disc text-sm text-gray-700 space-y-5 mt-5">
            <li>
              Built environment with ramps/lifts for easy access to classrooms.
            </li>
            <li>Disabled-friendly washrooms</li>
            <li>
            ...
            <div className="my-2">
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/7.1.7 Template.xlsx"
              ...
              <div className="flex flex-col my-2 text-sm">
                ...
                <div className="flex flex-row">
                  <div className="p-6 w-1/2 border border-gray-400 rounded-bl-md">
                    Policy documents and information brochures on the support to
                    be provided
                  </div>
                ...
                <div className="flex flex-row">
                  <div className="p-6 w-1/2 border border-gray-400 rounded-bl-md">
                    Details of the Software procured for providing the
                    assistance
                  </div>
                  <div className="p-6 w-1/2 border border-gray-400 rounded-br-md"></div>
                </div>
              ...
              <div className="select-none  relative flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label
                    ...
                    className="font-base cursor-pointer text-gray-700"
                  >
                    Assistive technology and facilities for persons with
              ...
              <div className="select-none  relative flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label
                    ...
                    className="font-base cursor-pointer text-gray-700"
                  >
                    Provision for enquiry and information : Human assistance,
