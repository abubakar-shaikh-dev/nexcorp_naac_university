...
export default function Metric_2_6_3() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 2.6.3</span>
        ...
        <div className="flex justify-between items-start">
          <span className="text-sm">Weightage : 30</span>
            ...
            <div className="my-2">
              ...
              <table className="w-full">
                <tbody>
                  ...
                  <tr className="text-sm">
                    <td className="p-4 border border-gray-400">
                    Total number of final year students who passed the university examination year wise during the last five years
                    </td>
                    <td className="p-4 border border-gray-400">
                      <InputTag
                        name="response2"
                  ...
                  <tr className="text-sm">
                    <td className="p-4 border border-gray-400">
                    Total number of final year students who appeared for the university examination year wise during the last five years
                    </td>
                    <td className="p-4 border border-gray-400">
                      <InputTag
                        name="response2"
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/2.6.3 Template.xlsx"
