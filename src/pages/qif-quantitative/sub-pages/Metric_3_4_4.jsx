...
export default function Metric_3_4_4() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 3.4.4</span>
            ...
            <div className="my-2">
              ...
              <table className="w-full">
                <tbody>
                  ...
                  <tr className="text-sm">
                    <td className="p-4 border border-gray-400">
                      3.4.4.1: Total number of Students participating in
                      extension activities conducted in collaboration with
                      industry, community and NonGovernment Organizations such
                      as Swachh Bharat, AIDs awareness, Gender issue etc. year
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/3.4.4 Template.xlsx"
          ...
          <div className="flex flex-col gap-3 mt-8">
            ...
            <table className="w-full">
              <tbody>
                ...
                <tr className="text-sm">
                  <td className="p-4 border border-gray-400">
                    3.4.4.1: Total number of Students participating in extension
                    activities conducted in collaboration with industry,
                    community and NonGovernment Organizations such as Swachh
                    Bharat, AIDs awareness, Gender issue etc. year wise during
                    last five years
                  </td>
                  <td className="p-4 border border-gray-400">
            ...
            <ul className="list-decimal text-sm text-gray-700 space-y-5 pl-6">
              ...
              <li>Number of teachers participating in such activities</li>
            ...
            <div className="flex flex-col my-2 ">
              <div className="flex flex-row">
                <div className="flex justify-between items-center p-6 w-[66.66%] border border-gray-400 ">
                  <span className="text-sm w-[66.6%]">Report of the event</span>
