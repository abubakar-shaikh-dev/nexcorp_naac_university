...
export default function Metric_3_4_3() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 3.4.3</span>
        ...
        <span>
          ...
          organised in collaboration with industry, community and NGOs during
          the last five years
        </span>
            ...
            <div className="my-2">
              ...
              <table className="w-full">
                <tbody>
                  ...
                  <tr className="text-sm">
                    <td className="p-4 border border-gray-400">
                      3.4.3.1: Number of extension and outreached Programmes
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/3.4.3 Template.xlsx"
            ...
            <table className="w-full">
              <tbody>
                ...
                <tr className="text-sm">
                  <td className="p-4 border border-gray-400">
                    3.4.3.1: Number of extension and outreached Programmes
                    conducted in collaboration with industry, community and Non-
                    Government Organizations through NSS/ NCC/ Red Cross/ YRC
