...
export default function Metric_7_1_10() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 7.1.10</span>
            ...
            <div className="my-2">
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/7.1.10 Template.xlsx"
              ...
              <div className="flex flex-col my-2 text-sm">
                ...
                <div className="flex flex-row">
                  <div className="p-6 w-1/2 border border-gray-400 rounded-bl-md">
                    Details of the monitoring committee composition and minutes
                    of the committee meeting, number of programmes organized,
                    reports on the various programs etc., in support of the
                    claims.
                  </div>
              ...
              <div className="select-none  relative flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label
                    ...
                    className="font-base cursor-pointer text-gray-700"
                  >
                    There is a committee to monitor adherence to the Code of
                    Conduct
                  </label>
                </div>
              </div>
              ...
              <div className="select-none  relative flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label
                    ...
                    className="font-base cursor-pointer text-gray-700"
                  >
                    Institution organizes professional ethics programmes for
