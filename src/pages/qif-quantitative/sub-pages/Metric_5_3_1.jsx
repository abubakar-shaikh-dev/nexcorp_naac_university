...
export default function Metric_5_3_1() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 5.3.1</span>
            ...
            <div className="my-2">
              ...
              <table className="w-full">
                <tbody>
                  ...
                  <tr className="text-sm">
                    <td className="p-4 border border-gray-400">
                      5.3.1.1: Number of awards/medals for outstanding
                      performance in sports/cultural activities at
                      university/state/ national / international level (award
                      for a team event should be counted as one) year wise
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/5.3.1 Template.xlsx"
          ...
          <div className="flex flex-col gap-3 mt-8">
            ...
            <table className="w-full">
              <tbody>
                ...
                <tr className="text-sm">
                  <td className="p-4 border border-gray-400">
                    5.3.1.1: Number of awards/medals for outstanding performance
                    in sports/cultural activities at university/state/ national
            ...
            <InputTag
              name="percentage-attainment-metric"
              placeholder="Response"
              type="number"
              min="0"
              max="100"
            ...
            <ul className="list-disc text-sm text-gray-700 space-y-5 pl-6">
              <li>Name of the award/ medal</li>
              <li>University /State/National/ International</li>
