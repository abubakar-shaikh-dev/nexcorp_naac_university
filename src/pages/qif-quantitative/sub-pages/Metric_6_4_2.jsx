...
export default function Metric_6_4_2() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 6.4.2</span>
        ...
        <div className="flex justify-between items-start">
          <span className="text-sm">Weightage : 8</span>
            ...
            <div className="my-2">
                ...
                <tbody>
                  ...
                  <tr className="text-sm">
                    <td className="p-4 border border-gray-400">
                      ...
                      individuals, Philanthropers year wise during the last five
                      years (INR in Lakhs)
                    </td>
                    <td className="p-4 border border-gray-400">
                      <InputTag
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/6.4.2 Template.xlsx"
