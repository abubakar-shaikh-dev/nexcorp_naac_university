...
export default function Metric_5_1_2() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 5.1.2</span>
        ...
        <div>
            ...
            <div className="my-2">
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/5.1.2 Template.xlsx"
          ...
          <div className="flex flex-col gap-3 mt-8">
            ...
            <ul className="list-disc text-sm text-gray-700 space-y-5 pl-6">
              <li>Name of the Scheme with contact information</li>
