...
export default function Metric_2_1_2() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 2.1.2</span>
        ...
        <span>
          ...
          reservation policy) during the last five years ( exclusive of
          supernumerary seats)
        </span>
            ...
            <div className="my-2">
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/2.1.2 Template.xlsx"
