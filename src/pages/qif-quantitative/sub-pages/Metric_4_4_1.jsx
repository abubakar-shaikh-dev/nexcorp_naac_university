...
export default function Metric_4_4_1() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 4.4.1</span>
            ...
            <div className="my-2">
              ...
              <table className="w-full">
                <tbody>
                  ...
                  <tr className="text-sm">
                    <td className="p-4 border border-gray-400">
                      Total expenditure excluding salary component
                    </td>
                    <td className="p-4 border border-gray-400">
                      <InputTag
                        name="response2"
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/4.4.1 Template.xlsx"
