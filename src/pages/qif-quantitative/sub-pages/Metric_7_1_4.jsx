...
export default function Metric_7_1_4() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 7.1.4</span>
            ...
            <div className="my-2">
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/7.1.4 Template.xlsx"
              ...
              <div className="select-none  relative flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label
                    ...
                    className="font-base cursor-pointer text-gray-700"
                  >
                    Maintenance of water bodies and distribution system in the
                    campus
                  </label>
                </div>
              </div>
