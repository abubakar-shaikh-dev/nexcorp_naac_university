...
export default function Metric_6_3_3() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 6.3.3</span>
            ...
            <div className="my-2">
              ...
              <table className="w-full">
                <tbody>
                  ...
                  <tr className="text-sm">
                    <td className="p-4 border border-gray-400">
                      6.3.3.1: Total number of professional development /
                      administrative training Programmes organized by the
                      Institution for teaching and non teaching staff year wise
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/6.3.3 Template.xlsx"
