...
export default function Metric_6_3_4() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 6.3.4</span>
          ...
          <div className="flex flex-col bg-[#f5f8ff] rounded-xl shadow-lg py-5 px-5 my-3">
            ...
            <div className="my-2">
                ...
                <tbody>
                  ...
                  <tr className="text-sm">
                    <td className="p-4 border border-gray-400">
                      ...
                      development Programmes viz., Orientation / Induction
                      Programme, Refresher Course, Short Term Course year wise
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/6.3.4 Template.xlsx"
            ...
            <div>
              ...
              <div className="flex flex-col my-2 text-sm">
                ...
                <div className="flex flex-row">
                  <div className="p-6 w-1/2 border border-gray-400 ">
                    Reports of the Human Resource Development Centres (UGC ASC
