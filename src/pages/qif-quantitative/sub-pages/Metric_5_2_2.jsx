...
export default function Metric_5_2_2() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 5.2.2</span>
        ...
        <div>
            ...
            <div className="my-2">
                ...
                <tbody>
                  <tr className="text-sm">
                    <td className="p-4 border border-gray-400 ">
                      5.2.2.1: Number of outgoing student progression to higher
                      education
                    </td>
                    <td className="p-4 border border-gray-400">
                      <InputTag
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/5.2.2 Template.xlsx"
          ...
          <div className="flex flex-col gap-3 mt-8">
            ...
            <span className=" mt-1">Number of students proceeding from</span>
            <ul className="list-disc text-sm text-gray-700 space-y-5 pl-6">
              <li>UG to PG</li>
              <li>PG to MPhil</li>
              <li>PG to PhD</li>
              <li>MPhil to PhD</li>
              <li>PhD to Post doctoral</li>
            </ul>
