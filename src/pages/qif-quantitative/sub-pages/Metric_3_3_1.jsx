...
export default function Metric_3_3_1() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 3.3.1</span>
        ...
        <span>
          Number of Ph.Ds registered per eligible teacher during the last five
          years
        </span>
            ...
            <div className="my-2">
                ...
                <tbody>
                  <tr className="text-sm">
                    <td className="p-4 border border-gray-400 ">
                      3.3.1.1: How many Ph.Ds registered per eligible teacher
                  ...
                  <tr className="text-sm">
                    <td className="p-4 border border-gray-400">
                      3.3.1.2: Number of teachers recognized as guides during
                      the last five years
                    </td>
                    <td className="p-4 border border-gray-400 ">
                      <InputTag
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/3.3.1 Template.xlsx"
          ...
          <div className="flex flex-col gap-3 mt-8">
            ...
            <table className="border border-gray-400  w-full">
              <tbody>
                ...
                <tr className="text-sm">
                  <td className="p-4 border border-gray-400">
                    3.3.1.2: Number of teachers recognized as guides during the
                    last five years
                  </td>
                  <td className="p-4 border border-gray-400">
