...
export default function Metric_5_2_3() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 5.2.3</span>
        ...
        <div>
            ...
            <div className="my-2">
              ...
              <table className="w-full">
                <tbody>
                  ...
                  <tr className="text-sm">
                    <td className="p-4 border border-gray-400">
                      5.2.3.1: Number of students qualifying in state/ national/
                      international level examinations (eg:
                      JAM/CLAT/NET/SLET/ATE/GMAT/CAT/GRE/TOEFL/Civil
                      Services/State government examinations) year wise during
                      last five years
                    </td>
                    <td className="p-4 border border-gray-400">
                      <InputTag
                  ...
                  <tr className="text-sm">
                    <td className="p-4 border border-gray-400">
                      5.2.3.2: Number of students appearing in state/ national/
                      international level examinations (eg:
                      JAM/CLAT/NET/SLET/GATE/GMAT/CAT,GRE/TOFEL/Civil
                      Services/State government examinations) year wise during
                      last five years
                    </td>
                    <td className="p-4 border border-gray-400">
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/5.2.3 Template.xlsx"
          ...
          <div className="flex flex-col gap-3 mt-8">
            ...
            <ul className="list-disc text-sm text-gray-700 space-y-5 pl-6">
              ...
              <li>State government examinations</li>
            </ul>
