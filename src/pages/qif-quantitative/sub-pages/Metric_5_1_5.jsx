...
export default function Metric_5_1_5() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 5.1.5</span>
        ...
        <span>
          ...
          <ul className="pl-6 list-decimal text-sm text-gray-700 space-y-5 mt-5">
            ...
            <li>
              Organisation wide awareness and undertakings on policies with zero
              tolerance
            </li>
            <li>
            ...
            <div className="my-2">
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/5.1.5 Template.xlsx"
              ...
              <div className="flex flex-col my-2 text-sm">
                ...
                <div className="flex flex-row">
                  <div className="p-6 w-1/2 border border-gray-400 rounded-bl-md">
                    Details of student grievances including sexual harassment
                    and ragging cases
                  </div>
          ...
          <div className="flex flex-col gap-3 mt-8">
            ...
            <ul className="list-disc text-sm text-gray-700 space-y-5 pl-10">
              <li>
                ...
                prevention of sexual harassment committee and anti ragging
                committee, constitution of various committees for addressing the
                issues, minutes of the meetings of the committees, number of
                cases received and redressed.
              </li>
            </ul>
