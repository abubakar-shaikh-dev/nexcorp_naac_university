    ...
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 1.1.3</span>
        ...
        <span>
          Teachers of the Institution participate in following activities
          related to curriculum development and assessment of the affiliating
          University and/are represented on the following academic bodies during
          the last five years
              ...
              <div className="select-none  relative flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label
                    ...
                    className="font-base cursor-pointer text-gray-700"
                  >
                    Setting of Question Papers for UG / PG Program.
                  </label>
                </div>
              </div>
