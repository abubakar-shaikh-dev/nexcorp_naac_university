...
export default function Metric_6_3_2() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 6.3.2</span>
            ...
            <div className="my-2">
              ...
              <table className="w-full">
                <tbody>
                  ...
                  <tr className="text-sm">
                    <td className="p-4 border border-gray-400">
                      6.3.2.1: Number of teachers provided with financial
          ...
          <div className="flex flex-col gap-3 mt-8">
            ...
            <table className="w-full">
              <tbody>
                ...
                <tr className="text-sm">
                  <td className="p-4 border border-gray-400">
                    6.3.2.1: Number of teachers provided with financial support
