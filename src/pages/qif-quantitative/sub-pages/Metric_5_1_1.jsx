...
export default function Metric_5_1_1() {
  return (
    <>
      <section className="flex flex-col gap-5">
        <div className="flex justify-between">
          <span className="font-semibold text-lg">Metric 5.1.1</span>
            ...
            <div className="my-2">
                ...
                <tbody>
                  ...
                  <tr className="text-sm">
                    <td className="p-4 border border-gray-400">
                      ...
                      freeships provided by the Government year wise during last
                      five years
                    </td>
                    <td className="p-4 border border-gray-400">
                      <InputTag
              ...
              <div className=" py-3 flex gap-4 flex-col sm:w-1/2 md:w-1/3">
                ...
                <div className="flex text-sm gap-4 justify-start items-center">
                  ...
                  <a
                    href="./templates/5.1.1 Template.xlsx"
